...
{    WaitRetrace;      { Do vertical retrace }
    DeleteAll(0);       { Delete old lines }
    ShowItAll(250);      { And show new stuff }
    drawfire;
flip(vaddr,vga);
Until KeyPressed;
...
repeat
settext;
writeln('Which fire do you want to see?');
writeln('1. Original Fire');
writeln('2. Fire Cube');
writeln('7. Run all of the fires');
writeln('0. Quit');
ch:=readkey;
case ch of
 '1':begin
...
begin;
 ...
 VideoMode($3);
 shutdown;                       {quit stuff}
 Writeln('FireDemo. Blair Harrison 1998');
