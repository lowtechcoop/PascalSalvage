...
uses dos,crt,gfx3,midas, mfile, mplayer, modp, errors, mconfig;
var x,y,f:integer;
    col:byte;
    a,b,c,d:word;
    mystring:string;
...
x:=0;
    ...
    until x>319;
x:=0;
   for a := 50000 downto 320 do  begin;
...
begin;
    ...
    module := midasLoadModule('e:\st\s\lotus.mod', @mpMOD, NIL);


randomize;
setupvirtual;
mystring:=('This is a test to see how well this works');
lents:=length(mystring);
setmcga;
stdpal;
...
textcolor(23);
gotoxy(2,10);
{if f=50 then write('This is Firetext ');}
{if f=100 then write('This is Firetext 222');
if f=150 then write('This is Firetext 333');
if f=200 then write('This is Firetext 444');}
