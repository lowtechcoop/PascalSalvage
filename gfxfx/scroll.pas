...
program Oldy;
{ very fast moving, oldy-based (meaing: a-la c64) 'smooth' scrolling text
  scroll, by Bas van Gaalen, Holland, PD }
uses
  crt, tpfast;
  ...
  repeat
    ...
    repeat
      ...
      repeat
        ...
        while (port[$3da] and 8) = 0 do;
        scrollx('l',1,ScrHigh-1,80,3,2,white);
        ...
        dspat(UpperLine[Pos+CharCounter-Len],79,ScrHigh-1,lightcyan);
        dspat(MiddleLine[Pos+CharCounter-Len],79,ScrHigh,lightcyan);
        dspat(LowerLine[Pos+CharCounter-Len],79,ScrHigh+1,lightcyan);
        dec(Len);
      until Len = 0;
      inc(PosCounter);
